...
class Search:
	...
	async def img(self, ctx, *, search):
		...
		print(url)
		em = discord.Embed(title="Image search for: {}".format(search), description='{}\n{}'.format(ctx.author.name,url), colour=cfg.colors['green'])
		em.set_image(url=url)
		em.set_thumbnail(url='https://duckduckgo.com/assets/logo_header.v107.min.png')
		#em = discord.Embed(title="Not yet implemented", description='I\'m sorry {}. I\'m afraid I can\'t do that :confused:'.format(ctx.author.name), colour=0xCC0000)
